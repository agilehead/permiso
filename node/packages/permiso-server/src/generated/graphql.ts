...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  Permission: ( Omit<RolePermission, 'resource' | 'role' | 'tenant'> & { resource: _RefType['Resource'], role: _RefType['Role'], tenant: _RefType['Tenant'] } ) | ( Omit<UserPermission, 'resource' | 'tenant' | 'user'> & { resource: _RefType['Resource'], tenant: _RefType['Tenant'], user: _RefType['User'] } );
}>;
...
export type ResolversTypes = ResolversObject<{
  ...
  Resource: ResolverTypeWrapper<Omit<Resource, 'permissions' | 'tenant'> & { permissions: Array<ResolversTypes['Permission']>, tenant: ResolversTypes['Tenant'] }>;
  ResourceConnection: ResolverTypeWrapper<Omit<ResourceConnection, 'nodes'> & { nodes: Array<ResolversTypes['Resource']> }>;
  ResourceFilter: ResourceFilter;
  Role: ResolverTypeWrapper<Omit<Role, 'permissions' | 'properties' | 'tenant' | 'users'> & { permissions: Array<ResolversTypes['RolePermission']>, properties: Array<ResolversTypes['Property']>, tenant: ResolversTypes['Tenant'], users: Array<ResolversTypes['User']> }>;
  RoleConnection: ResolverTypeWrapper<Omit<RoleConnection, 'nodes'> & { nodes: Array<ResolversTypes['Role']> }>;
  RoleFilter: RoleFilter;
  RolePermission: ResolverTypeWrapper<Omit<RolePermission, 'resource' | 'role' | 'tenant'> & { resource: ResolversTypes['Resource'], role: ResolversTypes['Role'], tenant: ResolversTypes['Tenant'] }>;
  SortDirection: SortDirection;
  String: ResolverTypeWrapper<Scalars['String']['output']>;
  Tenant: ResolverTypeWrapper<Omit<Tenant, 'properties' | 'resources' | 'roles' | 'users'> & { properties: Array<ResolversTypes['Property']>, resources: ResolversTypes['ResourceConnection'], roles: ResolversTypes['RoleConnection'], users: ResolversTypes['UserConnection'] }>;
  TenantConnection: ResolverTypeWrapper<Omit<TenantConnection, 'nodes'> & { nodes: Array<ResolversTypes['Tenant']> }>;
  TenantFilter: TenantFilter;
  UpdateResourceInput: UpdateResourceInput;
  UpdateRoleInput: UpdateRoleInput;
  UpdateTenantInput: UpdateTenantInput;
  UpdateUserInput: UpdateUserInput;
  User: ResolverTypeWrapper<Omit<User, 'effectivePermissions' | 'permissions' | 'properties' | 'roles' | 'tenant'> & { effectivePermissions: Array<ResolversTypes['EffectivePermission']>, permissions: Array<ResolversTypes['UserPermission']>, properties: Array<ResolversTypes['Property']>, roles: Array<ResolversTypes['Role']>, tenant: ResolversTypes['Tenant'] }>;
  UserConnection: ResolverTypeWrapper<Omit<UserConnection, 'nodes'> & { nodes: Array<ResolversTypes['User']> }>;
  UserFilter: UserFilter;
  UserPermission: ResolverTypeWrapper<Omit<UserPermission, 'resource' | 'tenant' | 'user'> & { resource: ResolversTypes['Resource'], tenant: ResolversTypes['Tenant'], user: ResolversTypes['User'] }>;
}>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  PropertyInput: PropertyInput;
  Query: {};
  Resource: Omit<Resource, 'permissions' | 'tenant'> & { permissions: Array<ResolversParentTypes['Permission']>, tenant: ResolversParentTypes['Tenant'] };
  ResourceConnection: Omit<ResourceConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Resource']> };
  ResourceFilter: ResourceFilter;
  Role: Omit<Role, 'permissions' | 'properties' | 'tenant' | 'users'> & { permissions: Array<ResolversParentTypes['RolePermission']>, properties: Array<ResolversParentTypes['Property']>, tenant: ResolversParentTypes['Tenant'], users: Array<ResolversParentTypes['User']> };
  RoleConnection: Omit<RoleConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Role']> };
  RoleFilter: RoleFilter;
  RolePermission: Omit<RolePermission, 'resource' | 'role' | 'tenant'> & { resource: ResolversParentTypes['Resource'], role: ResolversParentTypes['Role'], tenant: ResolversParentTypes['Tenant'] };
  String: Scalars['String']['output'];
  Tenant: Omit<Tenant, 'properties' | 'resources' | 'roles' | 'users'> & { properties: Array<ResolversParentTypes['Property']>, resources: ResolversParentTypes['ResourceConnection'], roles: ResolversParentTypes['RoleConnection'], users: ResolversParentTypes['UserConnection'] };
  TenantConnection: Omit<TenantConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Tenant']> };
  TenantFilter: TenantFilter;
  UpdateResourceInput: UpdateResourceInput;
  UpdateRoleInput: UpdateRoleInput;
  UpdateTenantInput: UpdateTenantInput;
  UpdateUserInput: UpdateUserInput;
  User: Omit<User, 'effectivePermissions' | 'permissions' | 'properties' | 'roles' | 'tenant'> & { effectivePermissions: Array<ResolversParentTypes['EffectivePermission']>, permissions: Array<ResolversParentTypes['UserPermission']>, properties: Array<ResolversParentTypes['Property']>, roles: Array<ResolversParentTypes['Role']>, tenant: ResolversParentTypes['Tenant'] };
  UserConnection: Omit<UserConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['User']> };
  UserFilter: UserFilter;
  UserPermission: Omit<UserPermission, 'resource' | 'tenant' | 'user'> & { resource: ResolversParentTypes['Resource'], tenant: ResolversParentTypes['Tenant'], user: ResolversParentTypes['User'] };
}>;
...
export type MutationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  deleteTenant?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteTenantArgs, 'id'>>;
  deleteTenantProperty?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteTenantPropertyArgs, 'name' | 'tenantId'>>;
  ...
  setTenantProperty?: Resolver<ResolversTypes['Property'], ParentType, ContextType, RequireFields<MutationSetTenantPropertyArgs, 'name' | 'tenantId'>>;
  ...
  updateTenant?: Resolver<ResolversTypes['Tenant'], ParentType, ContextType, RequireFields<MutationUpdateTenantArgs, 'id' | 'input'>>;
...
export type QueryResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  tenantProperty?: Resolver<Maybe<ResolversTypes['Property']>, ParentType, ContextType, RequireFields<QueryTenantPropertyArgs, 'propertyName' | 'tenantId'>>;
  tenants?: Resolver<ResolversTypes['TenantConnection'], ParentType, ContextType, Partial<QueryTenantsArgs>>;
  tenantsByIds?: Resolver<Array<ResolversTypes['Tenant']>, ParentType, ContextType, RequireFields<QueryTenantsByIdsArgs, 'ids'>>;
...
export type TenantResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Tenant'] = ResolversParentTypes['Tenant']> = ResolversObject<{
  createdAt?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  properties?: Resolver<Array<ResolversTypes['Property']>, ParentType, ContextType>;
  resources?: Resolver<ResolversTypes['ResourceConnection'], ParentType, ContextType, Partial<TenantResourcesArgs>>;
  roles?: Resolver<ResolversTypes['RoleConnection'], ParentType, ContextType, Partial<TenantRolesArgs>>;
  updatedAt?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  users?: Resolver<ResolversTypes['UserConnection'], ParentType, ContextType, Partial<TenantUsersArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type TenantConnectionResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['TenantConnection'] = ResolversParentTypes['TenantConnection']> = ResolversObject<{
